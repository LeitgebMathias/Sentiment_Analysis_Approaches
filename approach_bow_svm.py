...
# Fit the Support Vector Machine to the training set, using the bag of words as 
...
output.to_csv( "Bag_of_Words_SVM_5000_Training_Size.csv", index=False, quoting=3 )
