...
for i in range(num_reviews):
    ...
    polarity_vader = scores['compound']
    polarity_vader = round((polarity_vader + 1) * 5)
    ...
    if polarity_vader > 5 and true_sentiment > 5:
        richtig += 1
    elif polarity_vader <= 5 and true_sentiment <= 5:
        richtig += 1
