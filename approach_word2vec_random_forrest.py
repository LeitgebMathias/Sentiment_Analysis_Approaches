...
if __name__ == '__main__':
    ...
    # Fit a Random Forrest to the training data
    ...
    output.to_csv( "Word2Vec_RandomForrest_Without_Stopwords.csv", index=False, quoting=3 )
    print ("Wrote Word2Vec_RandomForrest_Without_Stopwords.csv")
